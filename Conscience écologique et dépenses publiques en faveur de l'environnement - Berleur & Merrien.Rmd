...
ça marche pas ça, à voir pourquoi : 
...
reg1 <- lm(data = base_simple_propre, formula = PC_GDP_2016 ~ env2) # je sais pas quoi faire avec ça, mais à approfondir
...
resultat_classif <- HCPC(resultat_ACP, nb.clust = -1)
