...
Enfin, les donnéees issues de l'enquête EVS ne sont pas très solides, puisque le questionnaire EVS ne propose pas beaucoup de questions relatives à l'environnement, et celles-ci sont formuléees de manière non neutre, ce qui peut induire un biais dans les questions. Par exemple, la variable **soutien_pol_env** repose sur une seule question, qui oppose l'environnement à la croissance et l'emploi, dans un dilemme assez discutable. 
