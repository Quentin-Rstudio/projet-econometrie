...
Le signe négatif du coefficient associé à la variable **GINI_2017** rendant compte des inégalités  (modèle reg7) nous conforte dans l'idée que ces inégalités ont un impact négatif sur les dépenses de protection de l'environnement. Toutefois, il est possible que cet impact soit indirect. En effet\newline
