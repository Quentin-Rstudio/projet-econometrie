...
reg5bis <- lm(data=base_complete, formula = depenses_brutes_env ~ sensi_env + EPI.new +   EDUC_SUP_2017 + GINI_2017)
...
stargazer(reg5,reg6,reg5bis,reg6bis, header = F, title = "Modèles avec variables de contrôle, sans educ.sup.", column.labels =  c("reg3", "reg4", "reg3bis", "reg4bis"))

```

Là j'pensais parler un peu des modèles reg3, reg4, reg3bis, reg4bis. Ensuite, rajouter des modèles avec R2 plus élevé qui ne sont pas mis, puis faire des graphiques avec compare_models et check_model pour les meilleurs modèles. 

```{r linear-regression}

# confint(reg1bis) # permet d'afficher l'intervalle de confiance
...
# r2(reg1)
# 
# #Le modèle suppose que la régression est linéaire, les termes d’erreurs ont même variance, ils sont indépendants et issus d’une loi normale.
# #Avant d’interpréter les résultats il est indispensable de vérifier ces hypotheses.
# 
# 
# 
